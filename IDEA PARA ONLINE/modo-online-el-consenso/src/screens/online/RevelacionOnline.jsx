  ...
  if (revelarGradual && !yaTerminoRevelacion) {
    ...
    return (
      <div className="flex flex-col flex-1 p-6 max-w-md mx-auto w-full">
        ...
        <h1 className="text-2xl font-black uppercase text-center font-display mb-6">{nombreDe(jugadorIdActual)}</h1>
        ...
        <div className="grid grid-cols-2 gap-2.5 mb-6">
          {palabras.map((palabra, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`px-3 py-2.5 rounded-lg text-sm font-bold text-center border ${
                  coincide
