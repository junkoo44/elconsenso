...
export default function LobbySala() {
  ...
  const copiarLink = async () => {
    try {
      ...
      // Si el navegador no soporta clipboard, no rompemos nada, solo no confirmamos el copiado
    }
  };
      ...
      {soyHost ? (
        <>
          ...
          <button
            ...
            className="btn-touch w-full py-5 px-6 bg-neon-purple hover:bg-violet-750 disabled:opacity-40 disabled:pointer-events-none text-white font-extrabold rounded-2xl shadow-xl shadow-neon-purple/20 border-b-4 border-violet-900 tracking-widest text-sm uppercase"
            onClick={iniciar}
          >
            Iniciar Partida
          </button>
